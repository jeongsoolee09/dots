...
you should place your code here."
  ...
  ;; lsp config
  (defun disable-lsp-diagnostics ()
    (interactive)
    (setq lsp-diagnostics-mode nil)
    (setq lsp-diagnostics-mode-hook nil))
  (add-hook 'buffer-list-update-hook 'disable-lsp-diagnostics)
